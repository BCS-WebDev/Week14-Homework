...
import nlrod from './images/items/03.png';
import tearofgoddess from './images/items/04.png';
import chainvest from './images/items/05.png';
import negatron from './images/items/06.png';
import giantsbelt from './images/items/07.png';
import spatula from './images/items/08.png';
import spargloves from './images/items/09.png';

import deathblade from './images/items/11.png';
import giantslayer from './images/items/12.png';
import hextechgunblade from './images/items/13.png';
import spearofshojin from './images/items/14.png';
import guardianangel from './images/items/15.png';
import bloodthirster from './images/items/16.png';
import zekesherald from './images/items/17.png';
import bladeruinedking from './images/items/18.png';
import infinityedge from './images/items/19.png';

import rapidfirecannon from './images/items/22.png';
import guisoo from './images/items/23.png';
import statikk from './images/items/24.png';
import titansresolve from './images/items/25.png';
import runaans from './images/items/26.png';
import zzrot from './images/items/27.png';
import infiltalons from './images/items/28.png';
import lastwhisper from './images/items/29.png';

import rabadon from './images/items/33.png';
import ludens from './images/items/34.png';
import locketofsolari from './images/items/35.png';
import ionicspark from './images/items/36.png';
import morellonomicon from './images/items/37.png';
import battlecastarmor from './images/items/38.png';
import jeweledguantlet from './images/items/39.png';

import seraphs from './images/items/44.png';
import frozenheart from './images/items/45.png';
import chalice from './images/items/46.png';
import redemption from './images/items/47.png';
import starguardiancharm from './images/items/48.png';
import handofjustice from './images/items/49.png';

import bramblevest from './images/items/55.png';
import swordbreaker from './images/items/56.png';
import redbuff from './images/items/57.png';
import rebelmedal from './images/items/58.png';
import shroud from './images/items/59.png';

import dragonsclaw from './images/items/66.png';
import zephyr from './images/items/67.png';
import celestialorb from './images/items/68.png';
import quicksilver from './images/items/69.png';

import warmog from './images/items/77.png';
import protectorguard from './images/items/78.png';
import trapclaw from './images/items/79.png';

import forceofnature from './images/items/88.png';
import darkstarheart from './images/items/89.png';

import thiefsgloves from './images/items/99.png';
            ...
            <div className="col-3">
                <div className="row mb-sm-3">
                    <div className="col-12">
                        {
                            coreItems.map(item => <Thumbnail className="p-sm-1" src={item}/>)
                        }
                        <a href="#">
                ...
                <div className="row mb-sm-4">
                    <div className="col-12">
                        <img src={bfsword} style={{ height: 75 }}/>
